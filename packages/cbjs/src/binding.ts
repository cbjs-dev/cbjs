...
import { OneOf, ReplicaNumber } from '@cbjsdev/shared';
...
export interface CppScanIterator {
  ...
  next(
    callback: (err: CppError | null, result: CppRangeScanItem | undefined) => void
  ): void;
  cancel(): boolean;
}
...
export interface CppConnectionAutogen {
  ...
  managementGroupUpsert(
    ...
    callback: (err: CppError | null, result: CppManagementGroupUpsertResponse) => void
  ): void;
  ...
  managementBucketGetAll(
    ...
    callback: (err: CppError | null, result: CppManagementBucketGetAllResponse) => void
  ): void;
  ...
  managementClusterDescribe(
    ...
    callback: (err: CppError | null, result: CppManagementClusterDescribeResponse) => void
  ): void;
  ...
  managementQueryIndexDrop(
    ...
    callback: (err: CppError | null, result: CppManagementQueryIndexDropResponse) => void
  ): void;
  ...
  managementBucketFlush(
    ...
    callback: (err: CppError | null, result: CppManagementBucketFlushResponse) => void
  ): void;
  ...
  managementChangePassword(
    ...
    callback: (err: CppError | null, result: CppManagementChangePasswordResponse) => void
  ): void;
  ...
  managementBucketDescribe(
    ...
    callback: (err: CppError | null, result: CppManagementBucketDescribeResponse) => void
  ): void;
  ...
  managementViewIndexGetAll(
    ...
    callback: (err: CppError | null, result: CppManagementViewIndexGetAllResponse) => void
  ): void;
  managementBucketGet(
    options: CppManagementBucketGetRequest,
    callback: (err: CppError | null, result: CppManagementBucketGetResponse) => void
  ): void;
  managementBucketUpdate(
    options: CppManagementBucketUpdateRequest,
    callback: (err: CppError | null, result: CppManagementBucketUpdateResponse) => void
  ): void;
  managementBucketDrop(
    options: CppManagementBucketDropRequest,
    callback: (err: CppError | null, result: CppManagementBucketDropResponse) => void
  ): void;
  managementFreeform(
    options: CppManagementFreeformRequest,
    callback: (err: CppError | null, result: CppManagementFreeformResponse) => void
  ): void;
  managementScopeDrop(
    options: CppManagementScopeDropRequest,
    callback: (err: CppError | null, result: CppManagementScopeDropResponse) => void
  ): void;
  managementViewIndexUpsert(
    options: CppManagementViewIndexUpsertRequest,
    callback: (err: CppError | null, result: CppManagementViewIndexUpsertResponse) => void
  ): void;
  managementUserGetAll(
    options: CppManagementUserGetAllRequest,
    callback: (err: CppError | null, result: CppManagementUserGetAllResponse) => void
  ): void;
  managementScopeCreate(
    options: CppManagementScopeCreateRequest,
    callback: (err: CppError | null, result: CppManagementScopeCreateResponse) => void
  ): void;
  ...
  managementViewIndexDrop(
    ...
    callback: (err: CppError | null, result: CppManagementViewIndexDropResponse) => void
  ): void;
  ...
  managementUserUpsert(
    ...
    callback: (err: CppError | null, result: CppManagementUserUpsertResponse) => void
  ): void;
  ...
  managementScopeGetAll(
    ...
    callback: (err: CppError | null, result: CppManagementScopeGetAllResponse) => void
  ): void;
  managementUserGet(
    options: CppManagementUserGetRequest,
    callback: (err: CppError | null, result: CppManagementUserGetResponse) => void
  ): void;
  managementSearchIndexDrop(
    options: CppManagementSearchIndexDropRequest,
    callback: (err: CppError | null, result: CppManagementSearchIndexDropResponse) => void
  ): void;
  ...
  managementUserDrop(
    ...
    callback: (err: CppError | null, result: CppManagementUserDropResponse) => void
  ): void;
  ...
  managementRoleGetAll(
    ...
    callback: (err: CppError | null, result: CppManagementRoleGetAllResponse) => void
  ): void;
  managementGroupGetAll(
    options: CppManagementGroupGetAllRequest,
    callback: (err: CppError | null, result: CppManagementGroupGetAllResponse) => void
  ): void;
  ...
  managementCollectionDrop(
    ...
    callback: (err: CppError | null, result: CppManagementCollectionDropResponse) => void
  ): void;
  ...
  managementGroupGet(
    ...
    callback: (err: CppError | null, result: CppManagementGroupGetResponse) => void
  ): void;
  managementViewIndexGet(
    options: CppManagementViewIndexGetRequest,
    callback: (err: CppError | null, result: CppManagementViewIndexGetResponse) => void
  ): void;
  managementBucketCreate(
    options: CppManagementBucketCreateRequest,
    callback: (err: CppError | null, result: CppManagementBucketCreateResponse) => void
  ): void;
  ...
  managementGroupDrop(
    ...
    callback: (err: CppError | null, result: CppManagementGroupDropResponse) => void
  ): void;
  managementSearchIndexGet(
    options: CppManagementSearchIndexGetRequest,
    callback: (err: CppError | null, result: CppManagementSearchIndexGetResponse) => void
  ): void;
  ...
  managementQueryIndexBuild(
    ...
    callback: (err: CppError | null, result: CppManagementQueryIndexBuildResponse) => void
  ): void;
...
export interface CppBindingAutogen {
  ...
  protocol_subdoc_opcode: {
    get_doc: CppProtocolSubdocOpcode.get_doc;
    set_doc: CppProtocolSubdocOpcode.set_doc;
    remove_doc: CppProtocolSubdocOpcode.remove_doc;
    get: CppProtocolSubdocOpcode.get;
    exists: CppProtocolSubdocOpcode.exists;
    dict_add: CppProtocolSubdocOpcode.dict_add;
    dict_upsert: CppProtocolSubdocOpcode.dict_upsert;
    remove: CppProtocolSubdocOpcode.remove;
    replace: CppProtocolSubdocOpcode.replace;
    array_push_last: CppProtocolSubdocOpcode.array_push_last;
    array_push_first: CppProtocolSubdocOpcode.array_push_first;
    array_insert: CppProtocolSubdocOpcode.array_insert;
    array_add_unique: CppProtocolSubdocOpcode.array_add_unique;
    counter: CppProtocolSubdocOpcode.counter;
    get_count: CppProtocolSubdocOpcode.get_count;
    replace_body_with_xattr: CppProtocolSubdocOpcode.replace_body_with_xattr;
  };
...
export interface CppGenericError extends CppCodedError {
...
export interface CppKeyValueError extends CppCodedError {
  ctxtype: 'key_value';
  id: CppDocumentId;
  opaque: number;
  cas: CppCas;
...
export interface CppViewError extends CppCodedError {
  ctxtype: 'view';
  client_context_id: string;
...
export interface CppQueryError extends CppCodedError {
  ctxtype: 'query';
...
export interface CppSearchError extends CppCodedError {
  ctxtype: 'search';
  client_context_id: string;
  index_name: string;
  query: string;
...
export interface CppAnalyticsError extends CppCodedError {
  ctxtype: 'analytics';
  first_error_code: number;
  first_error_message: string;
  client_context_id: string;
...
export interface CppHttpError extends CppCodedError {
  ctxtype: 'http';
  client_context_id: string;
  method: string;
  path: string;
...
export type CppError = CppGenericError | CppServiceError | CppTxnAnyError;
...
export interface CppTransaction {
  ...
  getMulti(
    ...
    callback: (err: CppError | null, result: CppTransactionGetMultiResult | null) => void
  ): void;
