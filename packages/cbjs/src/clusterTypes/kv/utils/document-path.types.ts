 ...
 */
export type ExtractPathToType<Document, DocumentPath extends string, Type, Strict extends boolean = false> =
 ...
 */
export type ExtractPathToWritable<Document, DocumentPath extends string> =
  Document extends unknown ?
    DocumentPath extends unknown ?
 ...
 */
export type ExtractPathToWritableProperty<Document, DocumentPath extends string> =
  Document extends unknown ?
    DocumentPath extends unknown ?
 ...
 */
export type ExtractPathToWritableArrayIndex<D, P extends string, FilterType = never> =
  D extends unknown ?
    P extends unknown ?
                  ...
                  GetArrayInfo<SubDocArray> extends infer Info extends ArrayInfoShape ?
                    ...
                    Info['IsHeadStatic'] extends true ?
                      (TupleIndexes<Info['StaticSlice']> | -1) extends infer TupleIndex extends number ?
                        FilterType extends SubDocArray[TupleIndex] ? `${PathToArray}[${TupleIndex}]` :
                      never :
                    never :
 ...
 */
export type ExtractPathToArray<D, P extends string> =
  D extends unknown ?
    P extends unknown ?
 ...
 */
export type ExtractPathToObject<D, P extends string> =
  D extends unknown ?
    P extends unknown ?
      SubDocument<D, P> extends infer SubDoc ?
 ...
 */
export type ExtractPathToPrependableArray<D, P extends string> =
  D extends unknown ?
    P extends unknown ?
 ...
 */
export type ExtractPathToAppendableArray<D, P extends string> =
  D extends unknown ?
    P extends unknown ?
      SubDocument<D, P> extends infer SubDoc ?
        SubDoc extends ReadonlyArray<unknown> ?
 ...
 */
export type ExtractPathToRemovableArrayIndex<Document, DocumentPath extends string> =
  Document extends unknown ?
    DocumentPath extends unknown ?
      ExtractPathToArrayIndex<DocumentPath> extends infer PathToArrayIndex extends string ?
        PathTargetExpression<PathToArrayIndex> extends `${string}[${infer Index extends number}]` ?
          Extract<ParentDocument<Document, PathToArrayIndex>, ReadonlyArray<unknown>> extends infer ParentDoc extends ReadonlyArray<unknown> ?
 ...
 */
type PathToMaybeUndefinedProperty<Doc extends object> =
  ExtractPathToType<Doc, ExtractPathToWritableProperty<Doc, DocumentPath<Doc>>, undefined>
;
  ...
  PathToMaybeUndefinedProperty<Doc> extends infer PathToMaybeUndefined extends string ?
    PathToMaybeUndefined extends unknown ?
      ParentDocument<Doc, PathToMaybeUndefined> extends infer ParentDoc ?
        PathTargetExpression<PathToMaybeUndefined> extends infer PropName extends keyof ParentDoc ?
          IsExactly<Pick<ParentDoc, PropName>, Required<Pick<ParentDoc, PropName>>> extends false ?
 ...
 */
export type ExtractPathToInsertableArrayIndex<Document, DocumentPath extends string> =
  Document extends unknown ?
    DocumentPath extends unknown ?
      ExtractPathToArrayIndex<DocumentPath> extends infer PathToArrayIndex extends string ?
